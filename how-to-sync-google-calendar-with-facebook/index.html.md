...
Here is how you can add your upcoming Facebook events to your Google calendar and make sure you aren’t missing out on anything great! You will have the option of making these things public or to keep them private. So, here's **how to sync Google Calendar with Facebook**.

This does not yet work with the new version of Google Calendar, so you will need to switch to the classic version. Once you have added Facebook events to your calendar, you can switch back to the upgraded version of Google Calendar.

Next, go to Facebook.com/events while signed into your account. At the bottom right-hand side of your screen, right click on Upcoming Events. Then copy the link for your upcoming events.

Next, go back to the classic version of your Google Calendar and on the left-hand side of your screen, click on the down area next to Other Calendars. Click on add by URL and paste the URL into the box.

Now your Facebook events will show up on your Google Calendar! What types of things are on your calendar in January?
...
- [HTML article](https://apps.allwomenstalk.com/how-to-sync-google-calendar-with-facebook/)
